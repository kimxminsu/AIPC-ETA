...
Ext.define('Ext.exporter.File', {
     ...
     * - Safari 6.1+: max blob size n/a; Blobs may be opened instead of saved sometimes�봸ou may have
     * to direct your Safari users to manually press �뙓+S to save the file after it is opened.
    ...
    var navigator = window.navigator,
        saveAs = window.saveAs || (function(view) {
                ...
                // only get URL when necessary in case Blob.js hasn't overridden it yet
                    //20180403byAnna ...modified
                    , get_URL = function() {
                    	var obj = view.webkitURL;
                    		
                    	if(obj == null || typeof obj == 'string')
                    		obj = view.URL;
                    	if(obj == null || typeof obj == 'string')
                    		obj = window.webkitURL;
						if(obj == null || typeof obj == 'string')
                    		obj = window.URL ;                    		
                        return  obj || view;
                    }
