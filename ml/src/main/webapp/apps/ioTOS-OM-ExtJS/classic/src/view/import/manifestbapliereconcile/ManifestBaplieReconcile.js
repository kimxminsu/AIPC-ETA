Ext.define('IoTosOmExt.view.import.manifestbapliereconcile.ManifestBaplieReconcile', {
	extend : 'Ext.form.Panel',
	alias: 'widget.app-manifestbapliereconcile',
	requires:[
		'IoTosOmExt.view.import.manifestbapliereconcile.ManifestBaplieReconcileModel',
		'IoTosOmExt.view.import.manifestbapliereconcile.ManifestBaplieReconcileController',
	...
	detailViewAlias: 'app-manifestbapliereconciledetail',
	
	controller: 'manifestbapliereconcile',

	viewModel: {
		type: 'manifestbapliereconcile'
	},
			...
			items: [{
						...
						items : [{
							...
							items : [{
								...
								items: [
									...
									{ boxLabel: ViewUtil.getLabel('WRD_CTOM_ManifestBaplie'), name: 'compareMode', inputValue: CodeConstantsOM.compareMode.MANIFEST_BAPLIE},
									{ boxLabel: ViewUtil.getLabel('WRD_CTOM_OnlyManifest'), name: 'compareMode', inputValue: CodeConstantsOM.compareMode.ONLY_MANIFEST},
							...
							items : [{
								...
								xtype : 'button',
								text : ViewUtil.getLabel('WRD_CTOM_CreateManifest'),
								value : 'manifest',
								listeners : {
									click : 'onCreateManifestBaplie'
								},
								bind : {
									disabled : '{setDisabledCreateManifest}'
								}
							}]
						}]
					},{
						//Direct Fill Function
							...
							items : [{
								...
								items : [{
									...
									vertical: true,
									items: [
										{ boxLabel: ViewUtil.getLabel('WRD_CTOM_ManifestToBaplie'), name: 'direction', inputValue: '1', checked : true},
										{ boxLabel: ViewUtil.getLabel('WRD_CTOM_BaplieToManifest'), name: 'direction', inputValue: '2'},
									]
								},{
									xtype : 'component',
									flex : 1
				...
				items : [{
					...
					listeners: {
						...
						cellclick : 'onManifestBaplieReconcileGridClick'
					},
					 selModel: {
                  selType : 'rowmodel',
                  mode : 'SINGLE'
					...
					columns: {
						...
						items: GridUtil.getGridColumns('ManifestBaplieReconcileStatusGrid'),
					}
				},{
					xtype: 'tsb-datagrid',
					reference : 'refManifestGrid',
                  ...
                  mode : 'SINGLE'
					...
					columns: {
						...
						items: GridUtil.getGridColumns('ManifestBaplieReconcileManifestGrid'),
					},
					viewConfig: { 
					...
					columns: {
						...
						items: GridUtil.getGridColumns('ManifestBaplieReconcileBaplieGrid'),
					},
					viewConfig: {
						getRowClass: function(record, rowIndex, rowParams, store){
							return 'grid-checkboxrow-class';
