Ext.define('IoTosOmExt.view.operation.terminalholdlist.TerminalHoldListDetail', {
	extend: 'Ext.form.Panel',
	
	alias: 'widget.app-terminalholdlistdetail',
	...
	initComponent: function() {
		...
		Ext.apply(this, {
			...
			items: [{
               ...
               xtype : 'fieldset',
               title : ViewUtil.getLabel('WRD_CTOM_ResultOfTerminalHold'),
               layout : {
                  type : 'vbox',
                  align : 'stretch'
               },
               ...
               items : [{
                  ...
                  items : [{
							xtype : 'combobox',
							reference : 'ctlHoldCodeCombo',
                     fieldLabel : ViewUtil.getLabel('WRD_CTOM_HoldCode'),
                     bind : {
                        store : '{holdCodeStore}',
                        value : '{theDetail.holdCode}',
                     },
                     displayField : 'code',
                     valueField : 'code',
                     queryMode : 'local',
