 ...
 * 
 */
Ext.define('TSB.gux.berthMc.BerthWindowDrawMc', {
    extend: 'Ext.draw.sprite.Line',
    
    alias: 'widget.app-berthwindowdraw-mc',
	...
	render: function(surface, ctx) {
		...
		me.plans.each(function(record,idx){
			var berthCdIdx = me.berths.findExact('name',record.data.berthCD);
			if(berthCdIdx > -1) {
				berthRecord = me.berths.getAt(berthCdIdx);
				if(berthRecord.data.group === 1) {
