...
var AuthenticationContext = (function () {
    ...
    AuthenticationContext.prototype.login = function () {
        ...
        //var urlNavigate = this._getNavigateUrl('code', null) + '&nonce=' + encodeURIComponent(this._idTokenNonce) + "&resource=00000003-0000-0000-c000-000000000000";
//        var urlNavigate = this._getNavigateUrl('code', null) + '&nonce=' + encodeURIComponent(this._idTokenNonce) + "&amr_values=mfa&resource=" + CONSTANTS.AZURE_CLIENT_ID;
        var urlNavigate = this._getNavigateUrl('code', null) + '&nonce=' + encodeURIComponent(this._idTokenNonce);
