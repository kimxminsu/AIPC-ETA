 ...
 *      });
 */
Ext.define('TSB.ux.colorpick.Field', {
    ...
    createPicker: function() {
        ...
        me.presetPicker = presetPicker = popup.lookupReference('presetPicker');
        
        presetPicker.colors = me.colors;
        presetPicker.on({
            select: 'onPresetColorSelect',
            scope: me
        });
    ...
    onPresetColorSelect: function (picker, selColor) {
    ...
    updateValue: function (color) {
        ...
        //For preset
        if (me.presetPicker) {
//        	me.presetPicker.select(color);	//Not working
        }
    }
});