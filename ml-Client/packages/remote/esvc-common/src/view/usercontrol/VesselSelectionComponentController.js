Ext.define('ESVC.view.usercontrol.VesselSelectionController', {
	extend: 'ESVC.view.foundation.usercontrol.BaseUserController',

	alias: 'controller.vesselselectioncomponent',
	 ...
	 * CONSTANT START
	 */
	MAIN_STORE_NAME: 'vesselSelectionList',
	...
	openVesselSelectionListPopup: function(){   
		...
		var vslScheduleType = me.getView().getVesselScheduleType();
		var vslDepartureType = me.getView().getVesselDepartureType();
		var params = {
			vesselCode : vslCode,
			callYear : callYear,
			callSeq : callSeq,
			...
			vesselName : vslName,
			departStatus : status,
			vesselScheduleType : vslScheduleType,
			vesselDepartureType : vslDepartureType
		};
