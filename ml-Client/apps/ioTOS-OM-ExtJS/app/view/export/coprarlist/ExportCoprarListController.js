Ext.define('IoTosOmExt.view.export.coprarlist.ExportCoprarListController', {
	extend : 'ESVC.view.foundation.BaseViewController',
	
	requires : [
	],
	
	alias : 'controller.exportcoprarlist',

	/**
	 * =========================================================================================================================
	 * CONSTANT START
	 */
	MAIN_GRID_REF_NAME: 'refExportCoprarListGrid',		// Main Grid Name 
	MAIN_STORE_NAME: 'exportCoprarListStore',				// Main Store Name
	DEFAULT_MODEL : 'IoTosOmExt.model.export.coprarlist.ExportCoprarList',
	/**
	 * CONSTANT END
	 * =========================================================================================================================
	 */
	...
	onLoad : function() {
		...
		var searchParm = Ext.create('IoTosOmExt.model.export.coprarlist.SearchExportCoprarList');
	...
	// Grid Row Double
	onExportCoprarListGridDblClick: function(grid, td, cellIndex, record, tr, rowIndex, e, eOpts) {
		var me = this;
		if (record == null)
			return;
   ...
   onColumnRenderer : function(value, metaData, record, rowIndex, collIndex, store, view) {
	...
	getSearchCondition : function() {
      ...
      var params = me.createParam(searchParm);
		...
		if(vvdData) {
			...
			params['ixCd'] = CodeConstantsOM.ixcd.EXPORT;
		}
	...
	saveProcess:function(){
      ...
      if(isCreated) {
         detailItem.set('ixCd', CodeConstantsOM.ixcd.EXPORT);
      }
		...
		for(var i = 0; i < hazardInfoStore.data.items.length; i++) {
         ...
         record.set('ixCd', CodeConstantsOM.ixcd.EXPORT);
