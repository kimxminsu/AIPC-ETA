Ext.define('IoTosOmExt.view.code.partnercode.PartnerCode', {
	extend : 'Ext.form.Panel',
	alias: 'widget.app-partnercode',
	requires:[
	...
	detailViewAlias: 'app-partnercodedetail',
	...
	initComponent: function() {
		...
		Ext.apply(me, {
			items: [{
				...
				listeners: {
					celldblclick: 'onPartnerCodeGridDblclick',
				...
				columns: {
					...
					items: GridUtil.getGridColumns('PartnerCodeGrid'),
				}
			}],
			...
			dockedItems: [{
				...
				items: [{
					...
					items: [{
						...
						items:[{
							xtype:'combobox',
							reference:'ctlPartnerCodeTypeCmb',
							fieldLabel: ViewUtil.getLabel('WRD_CTCM_PartnerCodeType'),
							bind : {
								store : '{partnerCodeTypeStore}',
								value : '{theSearch.ptnrType}'
							},
							listeners:{
								select: 'onPartnerCodeTypeChange'
							},
							displayField : 'name',
							valueField : 'code',
							queryMode : 'local'
