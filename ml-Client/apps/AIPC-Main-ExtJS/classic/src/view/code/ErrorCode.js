Ext.define("Aipc.Main.view.code.ErrorCode", {
	extend: "Ext.form.Panel",
	alias: "widget.app-errorcode",
	requires: [
		"Aipc.Main.view.code.ErrorCodeModel",
		"Aipc.Main.view.code.ErrorCodeController",
			...
			items: [
				{
					...
					columns: {
						...
						items: [
							...
							{ text: "PORT_CODE", dataIndex: "code", width: 160 },
							{ text: "PORT_NAME", dataIndex: "name", width: 160 }
						],
					},
				},
				// {
