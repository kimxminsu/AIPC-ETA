Ext.define("Aipc.Main.view.result.ResultController", {
    ...
    DEFAULT_MODEL: "Aipc.Main.model.result.User",
    ...
    //     var me = this;
    //     var refs = me.getReferences();
    //     let vslFiled = refs.ctlErrorCodeErrCode;
    //     let vsl = vslFiled.getValue();
    //     // var searchParm = Ext.create("Aipc.Main.model.association.SearchUser");
    //     //
    //     // me.setSearchParm(searchParm);
    //     // me.getViewModel().setData({ theSearch: searchParm });
    ...
    onSearch: function (control) {
        ...
        let originPortField = refs.ctlErrorCodeErrCode;
        let destinationPortField = refs.ctlErrorCodeErrName;
        let shiptypeField = refs.ctlcomboTest;
        
        let originPort = originPortField.getValue();
        let destinationPort = destinationPortField.getValue();
        let shiptype = shiptypeField.getValue();
        ...
        //     return;
        // }
        if(!originPort || !destinationPort || !shiptype){
            return;
        }
        var params = {
